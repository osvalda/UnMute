      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="bg-card/90 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-16">
          ...
          <div className="flex items-center justify-between px-5 py-3 border-b border-border bg-background/70">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-primary font-medium">
                Your AI-Assisted Learning Programs
              </span>
            </div>
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10">
              Explore personalized learning programs created just for you. Each program is designed to help you enhance your English skills through engaging voice conversations with our AI assistant.
            </p>
            ...
            <div className="flex items-center justify-center gap-16 mt-10 font-mono">
              ...
              <div className="flex flex-col items-center">
                <p className="text-3xl text-primary">0 min</p>
                <p className="text-sm text-muted-foreground uppercase tracking-wide mt-1">
                  CREATION TIME
                </p>
              </div>
        ...
        <div className="mt-16 text-center">
          <Link href="/generate-program">
            ...
            >
              Enhance your English Knowledge Now
              <Sparkles className="ml-2 h-5 w-5" />
            </Button>
          </Link>
          <p className="text-muted-foreground mt-4">
            Join our AI-assisted learning program
          </p>
        </div>
      </div>
    </div>
