  ...
  try {
    const session: Session = await genAI.live.connect({
      ...
      config: {
        ...
        systemInstruction: `Please greet me as ${name} in audio! You are a helpful language learning assistant who is expecting an english word to help pronanuce.
        ...
        Keep responses brief for a voice chat, but always answer and do not leave user alone. Do not halucinate words or questions rather ask back if needed!`,
      },
      callbacks: callback,
    });
